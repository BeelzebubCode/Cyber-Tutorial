...
# 🧟 Zombie Scan (Idle Scan) - ซ่อนตัวให้เนียนด้วยซอมบี้
...
- [Nmap Man Page -sI](https://nmap.org/book/man-idlescan.html)

---

> 🎯 Zombie Scan เป็นหนึ่งในเทคนิค stealth ที่สุดในโลกการสแกน  
> ใช้ได้ดีเมื่อคุณต้องการซ่อนตัวจากสายตาทุกระบบตรวจจับ 🧟‍♂️
