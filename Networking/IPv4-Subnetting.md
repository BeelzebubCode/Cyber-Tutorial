...
**VLSM (Variable Length Subnet Mask)** คือการแบ่ง Subnet หลักให้ย่อยลงด้วย Mask ที่ต่างกัน ตามจำนวน Host ที่ต้องการจริงในแต่ละเครือข่ายย่อย → ไม่จำเป็นต้องแบ่งเท่า ๆ กัน

### ✨ ตัวอย่าง VLSM จาก 192.168.10.0/24
| Subnet | จำนวน Host ที่ต้องการ | Subnet Mask | Network Address | Range IP ใช้งาน | Broadcast |
|--------|------------------------|--------------|------------------|------------------|-----------|
| A      | 50                     | /26 (64 IPs) | 192.168.10.0     | .1 - .62         | .63       |
| B      | 20                     | /27 (32 IPs) | 192.168.10.64    | .65 - .94        | .95       |
| C      | 10                     | /28 (16 IPs) | 192.168.10.96    | .97 - .110       | .111      |
| D      | 4                      | /30 (4 IPs)  | 192.168.10.112   | .113 - .114      | .115      |

📌 ใช้จากมาก → น้อย เพื่อไม่ให้เสีย IP Range
