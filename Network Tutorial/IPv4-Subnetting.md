...
**VLSM (Variable Length Subnet Mask)** คือการแบ่ง Subnet แบบ "ไม่เท่ากัน" โดยใช้ Subnet Mask ที่ยืดหยุ่น เพื่อให้แต่ละเครือข่ายย่อยมีขนาดพอดีกับจำนวน Host ที่ต้องการใช้งาน → **ช่วยประหยัด IP Address**
